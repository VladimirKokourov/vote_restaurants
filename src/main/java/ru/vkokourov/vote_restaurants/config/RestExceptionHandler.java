package ru.vkokourov.vote_restaurants.config;
...
import ru.vkokourov.vote_restaurants.error.*;
...
import static ru.vkokourov.vote_restaurants.error.ErrorType.*;
...
public class RestExceptionHandler {
    ...
    static final Map<Class<? extends Throwable>, ErrorType> HTTP_STATUS_MAP = new LinkedHashMap<>() {
        {
// more specific first
            put(NotTodaysDateException.class, FORBIDDEN);
