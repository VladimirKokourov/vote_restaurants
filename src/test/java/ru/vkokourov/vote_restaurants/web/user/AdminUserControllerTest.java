package ru.vkokourov.vote_restaurants.web.user;
...
import static ru.vkokourov.vote_restaurants.web.user.AdminUserController.REST_URL;
import static ru.vkokourov.vote_restaurants.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
